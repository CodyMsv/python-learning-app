...
wsl.exe -d Ubuntu bash -c "pkill -f 'python3 app.py' 2>/dev/null; sleep 1"

REM Start a fresh Flask server
start "Learn Python Server" wsl.exe -d Ubuntu bash -c "cd /mnt/d/My\ Journey/python-learning-app && python3 app.py"
